package com.bukaedu.canal.listener;

import com.alibaba.otter.canal.protocol.CanalEntry;
import com.bukaedu.canal.config.RabbitMqConfig;
...
public class SpuListener {
    ...
    public void spuUp(CanalEntry.EventType eventType, CanalEntry.RowData rowData) {
        ...
        if("1".equals(oldMap.get("is_marketable")) && "0".equals(newMap.get("is_marketable")) ){
            rabbitTemplate.convertAndSend("goods_down_exchange","",newMap.get("id")); //发送到mq商品上架交换器上
        }
